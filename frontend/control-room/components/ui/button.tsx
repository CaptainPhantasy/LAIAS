      ...
      <button
        ...
        className={cn(
          ...
          // Variant styles
          {
            ...
            'bg-accent-cyan text-bg-primary hover:shadow-glow-cyan hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]':
              variant === 'primary',

            // Secondary - Purple outlined
            'bg-transparent border border-accent-purple text-accent-purple hover:bg-accent-purple/10 hover:shadow-glow-purple':
              variant === 'secondary',

            // Outline - Subtle border
            'bg-transparent border border-border text-text-primary hover:border-border-strong hover:bg-surface':
              variant === 'outline',
            ...
            // Destructive - Red
            'bg-error text-white hover:bg-error/90 hover:shadow-glow-error':
              variant === 'destructive',
