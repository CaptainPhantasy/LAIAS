...
async def get_current_user_info(current_user: DevUser = Depends(get_current_user)) -> UserResponse:
    """
...
async def update_current_user(
    update: UserUpdate, current_user: DevUser = Depends(get_current_user)
) -> UserResponse:
    """
