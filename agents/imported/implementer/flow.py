...
class ImplementerState(BaseModel):
    """Typed state for IMPLEMENTATION EVIDENCE PACKAGE."""
...
class ImplementerFlow(Flow[ImplementerState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> ImplementerState:
    ...
    @listen("initialize")
    async def execute(self, state: ImplementerState) -> ImplementerState:
        ...
        try:
            ...
            agent = Agent(
                role="IMPLEMENTATION EVIDENCE PACKAGE",
                goal="",
                backstory="""You are the IMPLEMENTATION EVIDENCE PACKAGE. """,
                tools=self.tools,
    ...
    @listen("execute")
    async def finalize(self, state: ImplementerState) -> ImplementerState:
