...
class OverwatchState(BaseModel):
    """Typed state for OVERWATCH VERIFICATION REPORT."""
...
class OverwatchFlow(Flow[OverwatchState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> OverwatchState:
    ...
    @listen("initialize")
    async def execute(self, state: OverwatchState) -> OverwatchState:
        ...
        try:
            ...
            agent = Agent(
                role="OVERWATCH VERIFICATION REPORT",
                goal="",
                backstory="""You are the OVERWATCH VERIFICATION REPORT. """,
                tools=self.tools,
    ...
    @listen("execute")
    async def finalize(self, state: OverwatchState) -> OverwatchState:
