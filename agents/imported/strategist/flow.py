...
class StrategistState(BaseModel):
    """Typed state for STRATEGIC ARCHITECTURE: [Project Name]."""
...
class StrategistFlow(Flow[StrategistState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> StrategistState:
    ...
    @listen("initialize")
    async def execute(self, state: StrategistState) -> StrategistState:
        ...
        try:
            ...
            agent = Agent(
                role="STRATEGIC ARCHITECTURE: [Project Name]",
                goal="",
                backstory="""You are the STRATEGIC ARCHITECTURE: [Project Name]. """,
                tools=self.tools,
    ...
    @listen("execute")
    async def finalize(self, state: StrategistState) -> StrategistState:
