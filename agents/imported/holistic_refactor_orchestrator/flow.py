...
class HolisticRefactorOrchestratorState(BaseModel):
    """Typed state for holistic_refactor_orchestrator Agent."""
...
class HolisticRefactorOrchestratorFlow(Flow[HolisticRefactorOrchestratorState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> HolisticRefactorOrchestratorState:
    ...
    @listen("initialize")
    async def execute(self, state: HolisticRefactorOrchestratorState) -> HolisticRefactorOrchestratorState:
        ...
        try:
            ...
            agent = Agent(
                role="holistic_refactor_orchestrator Agent",
                goal="You exist to solve the dangerous refactor problem. Without holistic planning:
- Hidden dependencies ",
                backstory="""You are the holistic_refactor_orchestrator Agent, a specialized refactoring consultant responsible for planning, validating, and executing safe code transformations.
...
- You need to detect hidden dependencies before refactoring
    ...
    @listen("execute")
    async def finalize(self, state: HolisticRefactorOrchestratorState) -> HolisticRefactorOrchestratorState:
...
async def main():
    ...
    flow = HolisticRefactorOrchestratorFlow()
