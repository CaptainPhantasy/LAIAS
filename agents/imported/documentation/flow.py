...
class DocumentationState(BaseModel):
    """Typed state for DOCUMENTATION REPORT."""
...
class DocumentationFlow(Flow[DocumentationState]):
    ...
    Category: development
    Tags: code, documentation, api, architecture
    """

    def __init__(self):
        super().__init__()
        self.tools = self._initialize_tools()
        logger.info("DOCUMENTATION REPORT initialized")
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> DocumentationState:
    ...
    @listen("initialize")
    async def execute(self, state: DocumentationState) -> DocumentationState:
        ...
        try:
            ...
            agent = Agent(
                ...
                goal="",
                backstory="""You are the DOCUMENTATION REPORT. """,
                tools=self.tools,
    ...
    @listen("execute")
    async def finalize(self, state: DocumentationState) -> DocumentationState:
