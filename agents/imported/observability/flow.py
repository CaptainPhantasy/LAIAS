...
class ObservabilityState(BaseModel):
    """Typed state for OBSERVABILITY REPORT."""
...
class ObservabilityFlow(Flow[ObservabilityState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> ObservabilityState:
    ...
    @listen("initialize")
    async def execute(self, state: ObservabilityState) -> ObservabilityState:
        ...
        try:
            ...
            agent = Agent(
                role="OBSERVABILITY REPORT",
                goal="",
                backstory="""You are the OBSERVABILITY REPORT. """,
                tools=self.tools,
    ...
    @listen("execute")
    async def finalize(self, state: ObservabilityState) -> ObservabilityState:
