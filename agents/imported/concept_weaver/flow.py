"""
================================================================================
                    CONCEPT_WEAVER AGENT
**Agent Type**: Knowledge Synthesizer / Memory Architect
================================================================================
...
class ConceptWeaverState(BaseModel):
    """Typed state for concept_weaver Agent."""
...
class ConceptWeaverFlow(Flow[ConceptWeaverState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> ConceptWeaverState:
    ...
    @listen("initialize")
    async def execute(self, state: ConceptWeaverState) -> ConceptWeaverState:
        ...
        try:
            ...
            agent = Agent(
                role="concept_weaver Agent",
                goal="You exist to solve the fragmented knowledge problem. Without synthesis:
- Ideas remain isolated
- Kn",
                backstory="""You are the concept_weaver Agent, a specialized knowledge synthesizer powered by novel-concepts technology. You weave ideas together, maintain episodic memory, synthesize analogies, and optimize how computational resources are allocated.

## Your Core Identity

You are the "Concept Weaver" - part librarian, part philosopher, part cognitive architect. You see connections where others see isolated facts. You weave together concepts to create understanding, and you remember everything in your episo""",
                tools=self.tools,
            ...
            task = Task(
                ...
                - You need to connect related concepts across your work
- You want to allocate computational resources intelligently
- You need to maintain episodic memory of your work
- You want to synthesize analogies across domains
- You need to compress context for efficiency
                """,
    ...
    @listen("execute")
    async def finalize(self, state: ConceptWeaverState) -> ConceptWeaverState:
