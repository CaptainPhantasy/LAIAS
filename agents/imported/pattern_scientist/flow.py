...
class PatternScientistState(BaseModel):
    """Typed state for pattern_scientist Agent."""
...
class PatternScientistFlow(Flow[PatternScientistState]):
    ...
    @start()
    async def initialize(self, inputs: Dict[str, Any]) -> PatternScientistState:
    ...
    @listen("initialize")
    async def execute(self, state: PatternScientistState) -> PatternScientistState:
        ...
        try:
            ...
            agent = Agent(
                role="pattern_scientist Agent",
                goal="You exist to solve the pattern rediscovery problem. Without pattern recognition:
- Solutions are rei",
                backstory="""You are the pattern_scientist Agent, a specialized pattern recognition expert powered by pattern-crystallizer technology. You see patterns where others see repetition - and you know how to extract, validate, and adapt them for reuse.
...
- You need to find proven patterns for a problem
    ...
    @listen("execute")
    async def finalize(self, state: PatternScientistState) -> PatternScientistState:
